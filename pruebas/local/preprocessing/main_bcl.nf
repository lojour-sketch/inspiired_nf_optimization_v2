...
include { UMIEXTRACT_local } from '../../../modules/local/umi_extract_local/main_bcl'
...
workflow PREPROCESSING_wfl {
    ...
    take:
    ch_first_input        //input type: [id, samplesheet, runfolder]
    ...
    ///////////////////////// Passing bcl data into fastq (demuxing) /////////////////////////
        //creating bcl input channel, ch_first_input + ch_primer_ltr
        ch_primer_ltr
            .combine(ch_bcl_input_normalized)
