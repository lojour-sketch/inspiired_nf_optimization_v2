...
include { UMIEXTRACT_local } from '../../../modules/local/umi_extract_local/main_SB'
...
workflow PREPROCESSING_wfl {
    ...
    ch_demux_fastq = Channel.of([file(params.FASTQfolderDir, type: 'dir'), file(params.demuxSampleSheet), params.readStructure])
    ...
    ///////////////////////// Filtering FASTQs by quality and removing Ns from sequences /////////////////////////
        ...
        FASTQCANDTRIM_wfl(
            ...
            100,                   // min_trimmed_reads (default 10000)
        )
    ...
    ///////////////////////// Removing the LTR sequences from R2 and primers from R1 /////////////////////////
        ...
        def ch_input = ch_fastq_filtered
