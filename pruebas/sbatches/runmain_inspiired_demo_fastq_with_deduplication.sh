...
nextflow run main_inspiired_demo_fastq_with_deduplication.nf \
    ...
    --FASTQfolderDir /home/lrenteria/inspiired_nf/INSPIIRED/inputs/demoDataSet/Data \
    --demuxSampleSheet /home/lrenteria/inspiired_nf/INSPIIRED/inputs/demoDataSet/demuxSampleSheet.tsv \
    --projectName Inspiired_demo_with_deduplication \
    -resume
