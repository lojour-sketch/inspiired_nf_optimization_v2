#!/bin/bash
#SBATCH --job-name=running_maindivided
...
#SBATCH --cpus-per-task=14      # Numero de CPUs por tarea
#SBATCH --mem=70G              # Memoria RAM necesaria
...
nextflow run maindivided.nf \
    ...
    --outputDir /home/lrenteria/inspiired_nf/output/ \
