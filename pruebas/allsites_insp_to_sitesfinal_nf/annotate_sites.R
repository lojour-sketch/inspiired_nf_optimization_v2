...
if(length(sites.final) > 0) {
    ...
    pdf(paste0("allsites_insp_to_sitesfinal_nf/fig_annot_", sample, '.pdf'))
...
WriteXLS::WriteXLS(final_output, paste0("allsites_insp_to_sitesfinal_nf/annotated_", sample, '.xlsx'))
