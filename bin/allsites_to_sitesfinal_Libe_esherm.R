...
standardizeSites_Libe <- function(unstandardizedSites){
  if(length(unstandardizedSites)>0){
    dereplicated <- dereplicateSites_Libe(unstandardizedSites)
